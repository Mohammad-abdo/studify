...
const AddStaticPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.error(error.response?.data?.message || 'Failed to create static page');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="space-y-6">
      ...
      >
        ...
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Add Static Page</h1>
          <p className="text-gray-600 mt-1">Create a new static content page</p>
        </div>
      </motion.div>
